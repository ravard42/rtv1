...
int						sphere_light_test(float *p,
							void *obj, t_sph *s, t_lght *l);
int						plan_light_test(float *p,
							void *obj, t_pln *pl, t_lght *l);
int						cylindre_light_test(float *p,
							void *obj, t_cyl *cy, t_lght *l);
int						cone_light_test(float *p,
							void *obj, t_con *co, t_lght *l);

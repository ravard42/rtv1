...
valeurs par defaut:
par defaut les origin sont placee a {0,0,0}  et les vecteurs necessaires a {0,0,1}.
la couleur par defaut est le blanc et les rayon sont placee a 1.
la valeur id_light pour les sphere et cylindre vaut 0 par defaut et la valeur id pour les light vaut 42 par defaut.
...
lum bri et ombre :
lum est un coef affectE a la couleur du pixel une fois tout les calcules effectues donc modifie juste l'intensitee de l'objet, il est par defaut a 1.
ombre est egalement  a 1 par defaut et signie que les objet bloquent la lumiere (sauf si id = id_light mais c est un cas particulier) . si ombre vaut 0 alors l'objet n'aura aucune ombre portee car il laissera passer toutes les lumieres qui lui arriveront dessus.
...
une ligne qui ne commence pas par cam, light, plan, sphere, cylindre ou cone ne sera pas pris en compte par le parseur et pourra ainsi etre utilisee en commentaire
